...
(function(){
	...
	function escolherLetras(){
		for (let i = 0 ; i < 5 ; i++){
			var item;
			array_letra = ['a.png','b.png','c.png','d.png','e.png','f.png','g.png','h.png','i.png','j.png','k.png','l.png','m.png','n.png','o.png','p.png','q.png','r.png','s.png','t.png','u.png','v.png','w.png','y.png','z.png'];
			item = array_letra[(Math.random()*array_letra.length)|0];
			
			var count = true ;
			for (let e = lestra_jogo.length-1 ; e >= 0 ; e--){
				if (item == lestra_jogo[e]) {
					i--;
					count = false;
				}
			}
	...
	for(var i = 0; i < 10; i++){
		...
		var img = {
			src: "images/alfabeto/" + lestra_jogo[i%5] ,
			id: i%5
		};
	...
	function startGame(){
		...
		for(let i = 0; i < 10; i++){
			...
			card.style.left = (i % 5) === 0 ? 5 + "px" : 5 + ((i % 5) * 120) + "px";
			card.style.top = i/5 >= 1 ? 210 + "px" : 5 + "px";
